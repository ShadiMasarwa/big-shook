...
function mediaUrl(item: MediaItem) {
  return `/api/storage${item.objectPath}`;
}
...
/** Convenience button that opens the picker and shows a thumbnail of the selected image */
      ...
      <div className="flex gap-2 items-start">
        ...
        <div className="flex-1 space-y-1.5">
          ...
          <Input
            ...
            placeholder="או הדבק כתובת URL ישירות..."
            dir="ltr"
            className="text-xs"
          />
        </div>
