    ...
    <div className="min-h-[100dvh] flex flex-col bg-background font-sans text-foreground">
      ...
      <Sheet open={mobileOpen} onOpenChange={setMobileOpen}>
        <SheetContent side="right" className="w-72 p-0 flex flex-col" dir="rtl">
          ...
          {/* Mobile search */}
          <form onSubmit={handleSearch} className="px-4 py-3 border-b flex gap-2">
            <Input
          ...
          <nav className="flex-1 overflow-y-auto">
            ...
            <div className="px-4 py-2 border-t mt-2">
              <p className="text-xs text-muted-foreground font-semibold uppercase tracking-wide mb-2">חשבון</p>
              <ul className="space-y-1">
                {user ? (
                  <>
                    <li className="px-3 py-2 text-sm font-medium">שלום, {user.firstName}</li>
                    <li>
                      <Link href="/orders" onClick={handleCategoryClick} className="flex items-center py-2 px-3 rounded-md hover:bg-muted text-sm">
                        ההזמנות שלי
                      </Link>
                    </li>
                    <li>
                      <Link href="/loyalty" onClick={handleCategoryClick} className="flex items-center py-2 px-3 rounded-md hover:bg-muted text-sm">
                        מועדון לקוחות
                      </Link>
                    </li>
                    <li>
                  ...
                  <li>
                    <Link href="/auth" onClick={handleCategoryClick} className="flex items-center gap-2 py-2 px-3 rounded-md hover:bg-muted text-sm">
